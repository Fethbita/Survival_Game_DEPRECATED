...
HEALTHBAR = display.newRoundedRect(400, 6, 780, 12, 6);
HEALTHBAR:setFillColor(255/255, 255/255, 255/255);
main_group:insert(HEALTHBAR);

ENERGYBAR = display.newRoundedRect(400, 18, 780, 12, 6);
...
calendar_icon.x = _SCREEN.CENTER.x + 150;
calendar_icon.y = _SCREEN.CENTER.y - 645;
