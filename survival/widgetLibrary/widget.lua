...
function widget.newScrollView( options )
	local _scrollView = require( "widgetLibrary.widget_scrollview" )
...
function widget.newTableView( options )
	...
	local _tableView = require( "widgetLibrary.widget_tableview" )
...
function widget.newPickerWheel( options )
	...
	local _pickerWheel = require( "widgetLibrary.widget_pickerWheel" )
...
function widget.newSlider( options )
	...
	local _slider = require( "widgetLibrary.widget_slider" )
...
function widget.newTabBar( options )
	...
	local _tabBar = require( "widgetLibrary.widget_tabbar" )
...
function widget.newButton( options )
	...
	local _button = require( "widgetLibrary.widget_button" )
...
function widget.newSpinner( options )
	...
	local _spinner = require( "widgetLibrary.widget_spinner" )
...
function widget.newSwitch( options )
	...
	local _switch = require( "widgetLibrary.widget_switch" )
...
function widget.newStepper( options )
	...
	local _stepper = require( "widgetLibrary.widget_stepper" )
...
function widget.newSearchField( options )
	...
	local _searchField = require( "widgetLibrary.widget_searchField" )
...
function widget.newProgressView( options )
	...
	local _progressView = require( "widgetLibrary.widget_progressView" )
...
function widget.newSegmentedControl( options )
	...
	local _segmentedControl = require( "widgetLibrary.widget_segmentedControl" )
